...
def test_api_exposure_surface_validation_is_low_risk() -> None:
    result = evaluate_controlled_validation(
        make_request(
            action=(
                ControlledValidationAction
...
def test_injection_surface_validation_is_low_risk() -> None:
    result = evaluate_controlled_validation(
        make_request(
            action=(
                ControlledValidationAction
...
def test_browser_attack_surface_validation_is_low_risk() -> None:
    result = evaluate_controlled_validation(
        make_request(
            action=(
                ControlledValidationAction
